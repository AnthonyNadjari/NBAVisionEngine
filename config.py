...
# Posting — human-like but not glacial
WAIT_BEFORE_NEXT_TWEET_SEC_MIN = 25
WAIT_BEFORE_NEXT_TWEET_SEC_MAX = 60

# Scraping delays
SEARCH_WAIT_SEC_MIN = 3
SEARCH_WAIT_SEC_MAX = 5
SCROLL_WAIT_SEC_MIN = 1.5
SCROLL_WAIT_SEC_MAX = 3
SCROLL_DELTA_MIN = 1200
SCROLL_DELTA_MAX = 2000
SCROLL_COUNT = 5
CYCLE_INTERVAL_JITTER_SEC = 15
